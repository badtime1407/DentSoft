...
export function PatientFooter() {
  ...
  return (
    <footer className="bg-white border-t border-slate-100 mt-16">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 md:grid-cols-[1.6fr_1fr] gap-10">
        <div className="grid grid-cols-2 gap-8">
          <div>
            <p className="text-sm font-semibold text-slate-900 mb-3">ลิงก์ด่วน</p>
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900 mb-3">ติดต่อเรา</p>
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">© {year} DentSoft Clinic. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
