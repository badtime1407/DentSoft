        ...
        <div className="relative">
          ...
          {notifOpen && (
            <>
              ...
              <div className="fixed left-4 right-4 top-[4.5rem] sm:absolute sm:left-auto sm:top-auto sm:right-0 sm:mt-2 sm:w-96 bg-white rounded-2xl border border-gray-100 shadow-lg z-50 overflow-hidden">
