  ...
  return (
    <AuthLayout>
      ...
      <button
        ...
        className="w-full border border-gray-200 text-gray-700 py-2.5 rounded-xl hover:bg-gray-50 transition flex items-center justify-center gap-2 text-sm font-medium"
      >
